$(function(){
    ...
    function changeSlider(){
        setInterval(function(){
            $('.slider-single').eq(currentSlide).fadeOut();
            currentSlide++;
            ...
            $('.slider-single').eq(currentSlide).fadeIn();
    ...
    $('body').on('click', '.bullets span', function(){
        ...
        $('.slider-single').eq(currentSlide).stop().fadeOut();
        currentSlide = currentBullet.index();
        $('.slider-single').eq(currentSlide).stop().fadeIn();
        $('.bullets span').removeClass('active-slider');
